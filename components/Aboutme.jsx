  ...
  return (
    <div className='w-100 flex justify-center  '>
        <div className=" w-5/6 flex flex-col items-center justify-center content-center">
            ...
            <svg fill="none" className="animate-bounce mt-3" stroke="currentColor" strokeWidth={1.25} height="45px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"  aria-hidden="true">
