  ...
  return (
    <div className='w-100 h-screen flex justify-center  '>
        <div className=" w-5/6 flex flex-col items-center justify-center content-center">
            <h2 className="text-purple-600 font-bold text-4xl ">"User-friendly simplicity"</h2>
            <h4 className="text-lg font-thin w-5/6 my-6 text-center leading-8">
            ...
            <svg fill="none" className="animate-bounce text-purple-600 m-3" stroke="currentColor" strokeWidth={1.25} height="45px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"  aria-hidden="true">
